...
function Rr(t) {
  let n, e, r;
  t.length !== 2 ? (n = an, e = (s, u) => an(t(s), u), r = (s, u) => t(s) - u) : (n = t === an || t === Vi ? t : Wi, e = t, r = t);
...
function yo(t) {
  typeof t == "function" ? t = go(t) : t = Dr(t);
...
function wo(t) {
  return this.select(t == null ? vo : _o(typeof t == "function" ? t : qr(t)));
}
...
function $o(t) {
  return this.selectAll(t == null ? xo : Mo(typeof t == "function" ? t : qr(t)));
}
function To(t) {
...
function Po(t, n, e, r, i, o, a) {
  var s, u, l = /* @__PURE__ */ new Map(), h = n.length, d = o.length, c = new Array(h), f;
  for (s = 0; s < h; ++s)
    (u = n[s]) && (c[s] = f = a.call(u, u.__data__, s, n) + "", l.has(f) ? i[s] = u : l.set(f, u));
  for (s = 0; s < d; ++s)
    f = a.call(t, o[s], s, o) + "", (u = l.get(f)) ? (r[s] = u, u.__data__ = o[s], l.delete(f)) : e[s] = new hn(t, o[s]);
  for (s = 0; s < h; ++s)
...
function Oo(t, n) {
  ...
  var e = n ? Po : Eo, r = this._parents, i = this._groups;
  typeof t != "function" && (t = So(t));
  for (var o = i.length, a = new Array(o), s = new Array(o), u = new Array(o), l = 0; l < o; ++l) {
    var h = r[l], d = i[l], c = d.length, f = Io(t.call(h, h && h.__data__, l, r)), p = f.length, _ = s[l] = new Array(p), g = a[l] = new Array(p), m = u[l] = new Array(c);
    e(h, d, _, g, m, f, n);
...
function Jo(t, n) {
  ...
  return this.each((n == null ? e.local ? Yo : Uo : typeof n == "function" ? e.local ? Zo : Wo : e.local ? Vo : Ko)(e, n));
}
function Nr(t) {
...
function na(t, n, e) {
  return arguments.length > 1 ? this.each((n == null ? Qo : typeof n == "function" ? ta : jo)(t, n, e ?? "")) : $t(this.node(), t);
}
function $t(t, n) {
...
function ma(t) {
  return arguments.length ? this.each(t == null ? da : (typeof t == "function" ? ya : ga)(t)) : this.node().innerHTML;
}
function _a() {
...
function $a(t, n) {
  var e = typeof t == "function" ? t : Fr(t), r = n == null ? Ma : typeof n == "function" ? n : ve(n);
  return this.select(function() {
...
function Ra(t, n, e) {
  ...
  for (s = n ? ka : za, i = 0; i < o; ++i) this.each(s(r[i], n, e));
  return this;
}
function Yr(t, n, e) {
...
function La(t, n) {
  return this.each((typeof n == "function" ? Da : Fa)(t, n));
}
function* qa() {
  for (var t = this._groups, n = 0, e = t.length; n < e; ++n)
...
function Zn(t, n) {
  if (t = Na(t), n === void 0 && (n = t.currentTarget), n) {
...
const Ba = { passive: !1 }, Dt = { capture: !0, passive: !1 };
function Nn(t) {
...
function Wa() {
  var t = Ua, n = Ya, e = Ka, r = Va, i = {}, o = _e("start", "drag", "end"), a = 0, s, u, l, h, d = 0;
  function c(y) {
    y.on("mousedown.drag", f).filter(r).on("touchstart.drag", g).on("touchmove.drag", m, Ba).on("touchend.drag touchcancel.drag", x).style("touch-action", "none").style("-webkit-tap-highlight-color", "rgba(0,0,0,0)");
  }
  function f(y, w) {
    if (!(h || !t.call(this, y, w))) {
      var A = M(this, n.call(this, y, w), y, w, "mouse");
      A && (P(y.view).on("mousemove.drag", p, Dt).on("mouseup.drag", _, Dt), Xa(y.view), Nn(y), l = !1, s = y.clientX, u = y.clientY, A("start", y));
    }
  }
  function p(y) {
    if (bt(y), !l) {
  ...
  function _(y) {
    P(y.view).on("mousemove.drag mouseup.drag", null), Ga(y.view, l), bt(y), i.mouse("end", y);
  }
  function g(y, w) {
    if (t.call(this, y, w)) {
...
var Lt = 0.7, pn = 1 / Lt, xt = "\\s*([+-]?\\d+)\\s*", qt = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)\\s*", V = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*", Za = /^#([0-9a-f]{3,8})$/, Ja = new RegExp(`^rgb\\(${xt},${xt},${xt}\\)$`), Qa = new RegExp(`^rgb\\(${V},${V},${V}\\)$`), ja = new RegExp(`^rgba\\(${xt},${xt},${xt},${qt}\\)$`), ts = new RegExp(`^rgba\\(${V},${V},${V},${qt}\\)$`), ns = new RegExp(`^hsl\\(${qt},${V},${V}\\)$`), es = new RegExp(`^hsla\\(${qt},${V},${V},${qt}\\)$`), Be = {
  aliceblue: 15792383,
...
function ht(t) {
  var n, e;
  return t = (t + "").trim().toLowerCase(), (n = Za.exec(t)) ? (e = n[1].length, n = parseInt(n[1], 16), e === 6 ? Ue(n) : e === 3 ? new k(n >> 8 & 15 | n >> 4 & 240, n >> 4 & 15 | n & 240, (n & 15) << 4 | n & 15, 1) : e === 8 ? Qt(n >> 24 & 255, n >> 16 & 255, n >> 8 & 255, (n & 255) / 255) : e === 4 ? Qt(n >> 12 & 15 | n >> 8 & 240, n >> 8 & 15 | n >> 4 & 240, n >> 4 & 15 | n & 240, ((n & 15) << 4 | n & 15) / 255) : null) : (n = Ja.exec(t)) ? new k(n[1], n[2], n[3], 1) : (n = Qa.exec(t)) ? new k(n[1] * 255 / 100, n[2] * 255 / 100, n[3] * 255 / 100, 1) : (n = ja.exec(t)) ? Qt(n[1], n[2], n[3], n[4]) : (n = ts.exec(t)) ? Qt(n[1] * 255 / 100, n[2] * 255 / 100, n[3] * 255 / 100, n[4]) : (n = ns.exec(t)) ? Ve(n[1], n[2] / 100, n[3] / 100, 1) : (n = es.exec(t)) ? Ve(n[1], n[2] / 100, n[3] / 100, n[4]) : Be.hasOwnProperty(t) ? Ue(Be[t]) : t === "transparent" ? new k(NaN, NaN, NaN, 0) : null;
}
function Ue(t) {
...
function Qn(t, n, e, r) {
  return arguments.length === 1 ? os(t) : new k(t, n, e, r ?? 1);
}
function k(t, n, e, r) {
...
function Wr(t) {
  ...
  return s ? (n === o ? a = (e - r) / s + (e < r) * 6 : e === o ? a = (r - n) / s + 2 : a = (n - e) / s + 4, s /= u < 0.5 ? o + i : 2 - o - i, a *= 60) : s = u > 0 && u < 1 ? 0 : a, new N(a, s, u, t.opacity);
}
function ss(t, n, e, r) {
...
const gn = function t(n) {
  var e = fs(n);
  function r(i, o) {
    var a = e((i = Qn(i)).r, (o = Qn(o)).r), s = e(i.g, o.g), u = e(i.b, o.b), l = Zr(i.opacity, o.opacity);
    return function(h) {
...
function Jr(t, n) {
  var e = jn.lastIndex = Xn.lastIndex = 0, r, i, o, a = -1, s = [], u = [];
  for (t = t + "", n = n + ""; (r = jn.exec(t)) && (i = Xn.exec(n)); )
    (o = i.index) > e && (o = n.slice(e, o), s[a] ? s[a] += o : s[++a] = o), (r = r[0]) === (i = i[0]) ? s[a] ? s[a] += i : s[++a] = i : (s[++a] = null, u.push({ i: a, x: q(r, i) })), e = Xn.lastIndex;
...
function jr(t, n, e, r) {
  ...
  return function(l, h) {
    var d = [], c = [];
    return l = t(l), h = t(h), o(l.translateX, l.translateY, h.translateX, h.translateY, d, c), a(l.rotate, h.rotate, d, c), s(l.skewX, h.skewX, d, c), u(l.scaleX, l.scaleY, h.scaleX, h.scaleY, d, c), l = h = null, function(f) {
...
function Os(t, n) {
  ...
  if (e) {
    ...
    for (a in e) {
      ...
      i = r.state > ee && r.state < re, r.state = ln, r.timer.stop(), r.on.call(i ? "interrupt" : "cancel", t, t.__data__, r.index, r.group), delete e[a];
    }
...
function Rs(t, n) {
  ...
  if (t += "", arguments.length < 2) {
    for (var r = G(this.node(), e).tween, i = 0, o = r.length, a; i < o; ++i)
      if ((a = r[i]).name === t)
        return a.value;
    return null;
  }
...
function ou(t) {
  ...
  for (var n = this._groups, e = t._groups, r = n.length, i = e.length, o = Math.min(r, i), a = new Array(r), s = 0; s < o; ++s)
    for (var u = n[s], l = e[s], h = u.length, d = a[s] = new Array(h), c, f = 0; f < h; ++f)
      (c = u[f] || l[f]) && (d[f] = c);
  for (; s < r; ++s)
    a[s] = n[s];
...
function cu(t) {
  ...
  for (var r = this._groups, i = r.length, o = new Array(i), a = 0; a < i; ++a)
    for (var s = r[a], u = s.length, l = o[a] = new Array(u), h, d, c = 0; c < u; ++c)
...
function mu(t, n, e) {
  ...
  return function() {
    ...
    return s == null && (u = s = (this.style.removeProperty(t), $t(this, t))), a === u ? null : a === r && u === i ? o : (i = u, o = n(r = a, s));
  };
}
function _u(t, n) {
  var e, r, i, o = "style." + n, a = "end." + o, s;
  return function() {
    var u = Z(this, t), l = u.on, h = u.value[o] == null ? s || (s = oi(n)) : void 0;
    (l !== e || i !== h) && (r = (e = l).copy()).on(a, i = h), u.on = r;
  };
}
function vu(t, n, e) {
  var r = (t += "") == "transform" ? bs : ii;
  return n == null ? this.styleTween(t, gu(t, r)).on("end.style." + t, oi(t)) : typeof n == "function" ? this.styleTween(t, mu(t, r, Te(this, "style." + t, n))).each(_u(this._id, t)) : this.styleTween(t, yu(t, r, n), e).on("end.style." + t, null);
}
function wu(t, n, e) {
  return function(r) {
...
function Ru(t) {
  var n, e;
  t instanceof et ? (n = t._id, t = t._name) : (n = ai(), (e = zu).time = Sn(), t = t == null ? null : t + "");
  for (var r = this._groups, i = r.length, o = 0; o < i; ++o)
    for (var a = r[o], s = a.length, u, l = 0; l < s; ++l)
      (u = a[l]) && En(u, t, n, l, a, e || ku(u, n));
  return new et(r, this._parents, t, n);
}
Ut.prototype.interrupt = Is;
Ut.prototype.transition = Ru;
const ie = Math.PI, oe = 2 * ie, lt = 1e-6, Fu = oe - lt;
function si(t) {
  this._ += t[0];
...
class ui {
  ...
  arcTo(n, e, r, i, o) {
    ...
    let a = this._x1, s = this._y1, u = r - n, l = i - e, h = a - n, d = s - e, c = h * h + d * d;
    if (this._x1 === null)
      this._append`M${this._x1 = n},${this._y1 = e}`;
    else if (c > lt) if (!(Math.abs(d * u - l * h) > lt) || !o)
      this._append`L${this._x1 = n},${this._y1 = e}`;
    else {
      let f = r - a, p = i - s, _ = u * u + l * l, g = f * f + p * p, m = Math.sqrt(_), x = Math.sqrt(c), M = o * Math.tan((ie - Math.acos((_ + c - g) / (2 * m * x))) / 2), y = M / x, w = M / m;
      Math.abs(y - 1) > lt && this._append`L${n + y * h},${e + y * d}`, this._append`A${o},${o},0,0,${+(d * f > h * p)},${this._x1 = n + w * u},${this._y1 = e + w * l}`;
    }
  }
  arc(n, e, r, i, o, a) {
    if (n = +n, e = +e, r = +r, a = !!a, r < 0) throw new Error(`negative radius: ${r}`);
    let s = r * Math.cos(i), u = r * Math.sin(i), l = n + s, h = e + u, d = 1 ^ a, c = a ? i - o : o - i;
    this._x1 === null ? this._append`M${l},${h}` : (Math.abs(this._x1 - l) > lt || Math.abs(this._y1 - h) > lt) && this._append`L${l},${h}`, r && (c < 0 && (c = c % oe + oe), c > Fu ? this._append`A${r},${r},0,1,${d},${n - s},${e - u}A${r},${r},0,1,${d},${this._x1 = l},${this._y1 = h}` : c > lt && this._append`A${r},${r},0,${+(c >= ie)},${d},${this._x1 = n + r * Math.cos(o)},${this._y1 = e + r * Math.sin(o)}`);
  }
  rect(n, e, r, i) {
...
function Gu(t) {
  var n = t.grouping === void 0 || t.thousands === void 0 ? rr : qu(ir.call(t.grouping, Number), t.thousands + ""), e = t.currency === void 0 ? "" : t.currency[0] + "", r = t.currency === void 0 ? "" : t.currency[1] + "", i = t.decimal === void 0 ? "." : t.decimal + "", o = t.numerals === void 0 ? rr : Hu(ir.call(t.numerals, String)), a = t.percent === void 0 ? "%" : t.percent + "", s = t.minus === void 0 ? "−" : t.minus + "", u = t.nan === void 0 ? "NaN" : t.nan + "";
  function l(d) {
    d = vn(d);
    ...
    var A = _ === "$" ? e : _ === "#" && /[boxX]/.test(w) ? "0" + w.toLowerCase() : "", S = _ === "$" ? r : /[%p]/.test(w) ? a : "", C = er[w], Y = /[defgprs%]/.test(w);
    ...
    function J(b) {
      ...
      if (w === "c")
        ...
        b = +b;
        var ut = b < 0 || 1 / b < 0;
        if (b = isNaN(b) ? u : C(Math.abs(b), M), y && (b = Bu(b)), ut && +b == 0 && p !== "+" && (ut = !1), K = (ut ? p === "(" ? p : s : p === "-" || p === "(" ? "" : p) + K, O = (w === "s" ? or[8 + li / 3] : "") + O + (ut && p === "(" ? ")" : ""), Y) {
  ...
  function h(d, c) {
    var f = l((d = vn(d), d.type = "f", d)), p = Math.max(-8, Math.min(8, Math.floor(At(c) / 3))) * 3, _ = Math.pow(10, -p), g = or[8 + p / 3];
    return function(m) {
      return f(_ * m) + g;
    };
  }
...
function el() {
  var t = ar, n = ar, e = Me, r, i, o, a = wt, s, u, l;
  function h() {
    var c = Math.min(t.length, n.length);
    return a !== wt && (a = Qu(t[0], t[c - 1])), s = c > 2 ? tl : ju, u = l = null, d;
  }
  function d(c) {
...
function il(t, n, e, r) {
  ...
  switch (r = vn(r ?? ",f"), r.type) {
    case "s": {
      ...
      return r.precision == null && !isNaN(o = Ku(i, a)) && (r.precision = o), fi(r, a);
    }
    case "":
    case "e":
    case "g":
...
kt.prototype;
var ci = typeof global == "object" && global && global.Object === Object && global, al = typeof self == "object" && self && self.Object === Object && self, it = ci || al || Function("return this")(), W = it.Symbol, hi = Object.prototype, sl = hi.hasOwnProperty, ul = hi.toString, Ot = W ? W.toStringTag : void 0;
function ll(t) {
...
function af(t, n, e) {
  return n = hr(n === void 0 ? t.length - 1 : n, 0), function() {
    ...
    for (var s = Array(n + 1); ++i < n; )
      s[i] = r[i];
    return s[n] = e(a), Xl(t, this, s);
  };
}
function sf(t, n) {
  return Jl(af(t, n, On), t + "");
}
...
function bi(t, n) {
  var e = R(t), r = !e && Ee(t), i = !e && !r && ue(t), o = !e && !r && !i && wi(t), a = e || r || i || o, s = a ? yi(t.length, String) : [], u = s.length;
  for (var l in t)
...
var oc = "__lodash_hash_undefined__", ac = Object.prototype, sc = ac.hasOwnProperty;
function uc(t) {
  var n = this.__data__;
  if (Bt) {
    var e = n[t];
    return e === oc ? void 0 : e;
  }
...
var $i = "\\ud800-\\udfff", Wc = "\\u0300-\\u036f", Zc = "\\ufe20-\\ufe2f", Jc = "\\u20d0-\\u20ff", Qc = Wc + Zc + Jc, jc = "\\ufe0e\\ufe0f", th = "[" + $i + "]", le = "[" + Qc + "]", fe = "\\ud83c[\\udffb-\\udfff]", nh = "(?:" + le + "|" + fe + ")", Ti = "[^" + $i + "]", Ai = "(?:\\ud83c[\\udde6-\\uddff]){2}", Si = "[\\ud800-\\udbff][\\udc00-\\udfff]", eh = "\\u200d", Ei = nh + "?", Pi = "[" + jc + "]?", rh = "(?:" + eh + "(?:" + [Ti, Ai, Si].join("|") + ")" + Pi + Ei + ")*", ih = Pi + Ei + rh, oh = "(?:" + [Ti + le + "?", le, Ai, Si, th].join("|") + ")", ah = RegExp(fe + "(?=" + fe + ")|" + oh + ih, "g");
function sh(t) {
  return t.match(ah) || [];
}
function uh(t) {
...
function zi(t, n, e, r, i, o) {
  var a = e & kh, s = t.length, u = n.length;
  if (s != u && !(a && u > s))
    return !1;
...
function t0(t, n, e, r, i, o) {
  var a = e & Jh, s = wr(t), u = s.length, l = wr(n), h = l.length;
  if (u != h && !a)
    return !1;
  for (var d = u; d--; ) {
    var c = s[d];
    if (!(a ? c in n : jh.call(n, c)))
      return !1;
  }
  ...
  for (var g = a; ++d < u; ) {
    ...
    var m = t[c], x = n[c];
    if (r)
      var M = a ? r(x, m, c, n, t, o) : r(m, x, c, t, n, o);
    if (!(M === void 0 ? m === x || i(m, x, e, r, o) : M)) {
      _ = !1;
      break;
    }
    g || (g = c == "constructor");
...
function r0(t, n, e, r, i, o) {
  var a = R(t), s = R(n), u = a ? Pr : tt(t), l = s ? Pr : tt(n);
  ...
  if (c && !h)
    return o || (o = new nt()), a || wi(t) ? zi(t, n, e, r, i, o) : Zh(t, n, u, e, r, i, o);
  if (!(e & n0)) {
    var f = h && Cr.call(t, "__wrapped__"), p = d && Cr.call(n, "__wrapped__");
    if (f || p) {
      var _ = f ? t.value() : t, g = p ? n.value() : n;
      return o || (o = new nt()), i(_, g, e, r, o);
    }
  }
  return c ? (o || (o = new nt()), t0(t, n, e, r, i, o)) : !1;
}
...
function a0(t, n, e, r) {
  ...
  for (; ++i < o; ) {
    ...
    if (a[2]) {
      ...
      var h = new nt(), d;
      if (!(d === void 0 ? ke(l, u, i0 | o0, r, h) : d))
        return !1;
    }
  }
  return !0;
...
function Di(t, n, e) {
  ...
  return o || ++r != i ? o : (i = t == null ? 0 : t.length, !!i && Se(i) && In(a, i) && (R(t) || Ee(t)));
}
function f0(t, n) {
...
function X0(t, n, e, r) {
  for (var i = -1, o = B0(N0((n - t) / (e || 1)), 0), a = Array(o); o--; )
    a[++i] = t, t += e;
  return a;
}
function G0(t) {
...
const J0 = (t, n, e = 12, r = 12) => {
  const i = X().domain([0, e]).range([0, t]), o = X().domain([0, r]).range([0, n]);
  return {
    points: function() {
...
}, Q0 = "_widget_18g36_1", j0 = "_label_18g36_19", tp = "_lit_18g36_24", np = "_button_18g36_29", ep = "_symbol_18g36_29", rp = "_radio_18g36_29", ip = "_radiobutton_18g36_29", op = "_selected_18g36_35", ap = "_toggle_18g36_35", sp = "_slider_18g36_44", up = "_track_18g36_44", lp = "_track_overlay_18g36_48", fp = "_handle_18g36_55", v = {
  widget: Q0,
  label: j0,
  lit: tp,
  button: np,
  ...
  const n = U(), e = Math.PI / 2.5, r = e / 2, i = 2 * Math.PI - e / 2, o = 0.5, a = 0.6, s = 0.6, u = [t * (1 - o / 2) * Math.cos(i), t * (1 - o / 2) * Math.sin(i)], l = [t * s * Math.cos(i + Math.PI / 2), t * s * Math.sin(i + Math.PI / 2)];
  ...
  const n = U(), e = Math.PI / 10, r = t / 2, i = Math.PI - e, o = e, a = -e, s = Math.PI + e;
  ...
  const n = U(), e = Math.PI / 2.5, r = e / 2 + Math.PI, i = 2 * Math.PI - e / 2 + Math.PI, o = 0.5, a = 0.6, s = -0.6;
  ...
  const t = "button";
  var n = Ni(), e = 50, r = 0.3, i = "round", o = { x: 0, y: 0 }, a = null, s = "bottom", u = null, l = function(p) {
  }, h = ["play"], d = 0;
  return {
    type: t,
    id: function(p) {
  ...
  var e = Ni(), r = 100, i = 8, o = 10, a = !1, s = { x: 0, y: 0 }, u = "top-left", l = null, h = function(m) {
  }, d = function(m) {
  }, c = [0, 1], f = 0, p = null, _ = X().domain(c).range([0, r]).clamp(!0);
  const g = function(m, x, M = c) {
    const y = m.select("#slider_" + e);
    _.domain(M), f = x, y.selectAll("." + v.handle).transition().attr("cx", _(x)), a && y.select("." + v.label).text(p + " = " + n(f)), h(), d();
  };
  return {
    type: t,
    scale: _,
  ...
  }), a.append("path").attr("d", de(t.actions()[t.value()])(t.symbolsize() * t.size())).attr("class", v.symbol), r) {
  ...
  s.append("path").attr("d", Bi(t.size(), t.girth())).attr("class", v.track), s.append("circle").attr("class", v.handle).attr("r", t.knob()).attr("cx", a(t.value())), s.append("rect").attr("width", t.size() + 2 * l).attr("height", 2 * l).attr("transform", "translate(" + -l + "," + -l + ")").attr("class", v.track_overlay).on("click", function(p) {
    const _ = Zn(p, this)[0];
  ...
  if (s.append("path").attr("d", Bi(2 * t.size(), 2 * t.size())).attr("class", v.track), s.append("circle").attr("class", v.handle).attr("r", r).attr("cx", t.value() ? 2 * r : 0), s.append("rect").attr("width", 4 * t.size()).attr("height", 2 * t.size()).attr("class", v.track_overlay).attr("transform", "translate(" + -t.size() + "," + -t.size() + ")").on("click", t.click), i) {
    const u = De(4 * t.size(), 2 * t.size(), o);
...
const rn = [1, 0], on = [0.5, Math.sqrt(3) / 2], I = [
  { l: 1, m: 0, n: -1 },
  { l: 1, m: -1, n: 0 },
  { l: 0, m: -1, n: 1 },
  { l: 0, m: 1, n: -1 },
...
const kp = function(t) {
  ...
  const a = function(c) {
    return typeof c < "u" ? (e = c, r = e / (2 * t + 1), i.forEach((f) => {
      f.x = r * f.l * rn[0] + r * f.m * on[0], f.y = r * f.l * rn[1] + r * f.m * on[1];
    }), this.L = e, this) : e;
  }, s = function(c) {
    var f = 1 / Math.sqrt(3);
    return [
  ...
  function h(c) {
    c.forEach(function(f) {
      f.neighbors = [], I.forEach(function(p) {
        const _ = E({ l: f.l + p.l, m: f.m + p.m, n: f.n + p.n }), g = o[_];
...
const Dp = () => {
  ...
  return H(n, (e) => {
    ...
    let i = e.x + T.motility.widget.value() * Math.cos(e.theta), o = e.y + T.motility.widget.value() * Math.sin(e.theta);
    const a = j[e.home], s = (i - a.x) * (i - a.x) + (o - a.y) * (o - a.y);
    H(a.neighbors, (u) => {
      var l = (i - u.x) * (i - u.x) + (o - u.y) * (o - u.y);
      l < s && (u.state == "agar" ? (i = e.x, o = e.y, u.n_collisions += 1, u.n_collisions > T.resistance_of_medium.widget.value() && (u.state = "liquid")) : (e.home = u.index, u.is_boundary && (t = !0)));
    }), e.x = i, e.y = o;
